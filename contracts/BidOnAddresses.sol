...
// TODO: Separate smart contract that acts as a smart wallet of staked tokens. Make it feature rich. (Instead just set operator approval. Also ERC-20. Both wallets and smart wallets.)
// TODO: API to batch approve tokens for inheritance.
